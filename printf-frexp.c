/* printf-frexp.c: Split a double into fraction and mantissa, for hexadecimal
 * printf.
...
#  define FREXP frexpl
#  define LDEXP ldexpl
# endif /* HAVE_FREXPL_IN_LIBC && HAVE_LDEXPL_IN_LIBC */
...
#  define FREXP frexp
#  define LDEXP ldexp
# endif /* HAVE_FREXP_IN_LIBC && HAVE_LDEXP_IN_LIBC */
