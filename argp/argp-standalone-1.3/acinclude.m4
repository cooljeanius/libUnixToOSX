...
dnl#
dnl# if your headers require the stdint-types you will want to create an
...
dnl#
dnl# @,(status: used on new plats)(see http://ac-archive.sf.net/gstdint/)
...
if test "_${ac_header}" != "_" ; then
  if test "x${ac_header}" != "xstddef.h" ; then
...
#  endif /* !_STDINT_HEADER_U_INT32 */
# endif /* !_STDINT_HEADER_UINT32 */
#endif /* !_STDINT_HEADER_INTPTR */

#ifdef _STDINT_HAVE_U_INT_TYPES
# undef _STDINT_NEED_INT_MODEL_T
#endif /* _STDINT_HAVE_U_INT_TYPES */

#ifdef _STDINT_CHAR_MODEL
# if ((_STDINT_CHAR_MODEL + 0) == 122) || ((_STDINT_CHAR_MODEL + 0) == 124)
#  ifndef _STDINT_BYTE_MODEL
#   define _STDINT_BYTE_MODEL 12
#  endif /* !_STDINT_BYTE_MODEL */
# endif /* _STDINT_CHAR_MODEL checks */
#endif /* _STDINT_CHAR_MODEL */

#ifndef _STDINT_HAVE_INT_LEAST32_T
# define _STDINT_NEED_INT_LEAST_T
#endif /* !_STDINT_HAVE_INT_LEAST32_T */

#ifndef _STDINT_HAVE_INT_FAST32_T
# define _STDINT_NEED_INT_FAST_T
#endif /* !_STDINT_HAVE_INT_FAST32_T */

#ifndef _STDINT_HEADER_INTPTR
# define _STDINT_NEED_INTPTR_T
# ifndef _STDINT_HAVE_INTMAX_T
#  define _STDINT_NEED_INTMAX_T
# endif /* !_STDINT_HAVE_INTMAX_T */
#endif /* !_STDINT_HEADER_INTPTR */
...
#  endif /* misc. */
# endif /* C standard checks */
#endif /* !_HAVE_UINT64_T */

#if defined _STDINT_HAVE_U_INT_TYPES
/* int8_t int16_t int32_t defined by inet code, redeclare the u_intXX
 * types */
...
/* there a few 32-bit-only dsp-systems that we guard with BYTE_MODEL */
...
#  endif /* _STDING_LONG_MODEL checks */
# else
#  define _STDINT_NO_INT8_T
#  define _STDINT_NO_INT32_T
# endif /* _STDINT_BYTE_MODEL */
#endif /* _STDINT_NEED_INT_MODEL_T */

/*
 * quote from SunOS-5.8 sys/inttypes.h:
 * Use at your own risk.  As of February 1996, the committee is squarely
 * behind the fixed sized types; the "least" & "fast" types are still being
...
# endif /* _HAVE_UINT64_T */
  /* least types */
#endif /* _STDINT_NEED_INT_LEAST_T */
...
typedef  unsigned long  uintptr_t;
typedef           long   intptr_t;
#  endif /* _STDINT_LONG_MODEL checks */
# endif /* !__intptr_t_defined */
#endif /* _STDINT_NEED_INTPTR_T */
  /* shortcircuit*/
#  endif
  /* once */
# endif /* _GENERATED_STDINT_H */
#endif /* _ARGP_ARGP_STDINT_H */
STDINT_EOF
