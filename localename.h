/* localename.h: Determine name of the currently selected locale.
...
/* Determine the name of the current locale.
...
extern const char * gl_locale_name(int category,
								   const char *categoryname);

/* Determine the name of the current per-thread locale, as specified by
 * uselocale() calls.
 * CATEGORY is a locale category abbreviation, as defined in <locale.h>,
 * but not LC_ALL. E.g. LC_MESSAGES.
 * CATEGORYNAME is the name of CATEGORY as a string, e.g. "LC_MESSAGES".
 * Return the name of the locale category, canonicalized into XPG syntax
 *   language[_territory][.codeset][@modifier]
...
/* Determine the name of the default locale, as specified by environment
 * variables.
 * Return the name of the locale category, or NULL if no locale has been
