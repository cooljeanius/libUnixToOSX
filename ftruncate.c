/* ftruncate.c: ftruncate emulations for native Windows.
...
#if defined(HAVE_CHSIZE) && HAVE_CHSIZE
...
/* Ensure that <windows.h> declares GetFileSizeE:  */
#  undef _WIN32_WINNT
...
# endif /* _GL_WINDOWS_64_BIT_OFF_T || not */
#endif /* HAVE_CHSIZE */
