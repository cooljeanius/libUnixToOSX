...
#FIXME: we also check warning flags with gnulib macros; they have cache
# values like this:
test -z "${gl_cv_warn_c__Wall}"
# We should skip the checks here if they are just duplicating the gnulib
# ones...

# This chunk of warnings were those that existed in the legacy CWARNFLAGS:
XORG_TESTSET_CFLAG([[BASE_]PREFIX[FLAGS]],[-Wall])dnl
XORG_TESTSET_CFLAG([[BASE_]PREFIX[FLAGS]],[-Wpointer-arith])dnl
XORG_TESTSET_CFLAG([[BASE_]PREFIX[FLAGS]],[-Wmissing-declarations])dnl
XORG_TESTSET_CFLAG([[BASE_]PREFIX[FLAGS]],[-Wformat=2],[-Wformat])dnl

AC_LANG_CASE([C],[
  XORG_TESTSET_CFLAG([[BASE_]PREFIX[FLAGS]],[-Wstrict-prototypes])dnl
  XORG_TESTSET_CFLAG([[BASE_]PREFIX[FLAGS]],[-Wmissing-prototypes])dnl
  XORG_TESTSET_CFLAG([[BASE_]PREFIX[FLAGS]],[-Wnested-externs])dnl
  XORG_TESTSET_CFLAG([[BASE_]PREFIX[FLAGS]],[-Wbad-function-cast])dnl
...
if test "x${SELECTIVE_WERROR}" = "xyes"; then
  ...
  XORG_TESTSET_CFLAG([[BASE_]PREFIX[FLAGS]],[-Werror=nonnull])dnl
  XORG_TESTSET_CFLAG([[BASE_]PREFIX[FLAGS]],[-Werror=init-self])dnl
  XORG_TESTSET_CFLAG([[BASE_]PREFIX[FLAGS]],[-Werror=main])dnl
  XORG_TESTSET_CFLAG([[BASE_]PREFIX[FLAGS]],[-Werror=missing-braces])dnl
  XORG_TESTSET_CFLAG([[BASE_]PREFIX[FLAGS]],[-Werror=sequence-point])dnl
  XORG_TESTSET_CFLAG([[BASE_]PREFIX[FLAGS]],[-Werror=return-type],
                     [-errwarn=E_FUNC_HAS_NO_RETURN_STMT])dnl
  XORG_TESTSET_CFLAG([[BASE_]PREFIX[FLAGS]],[-Werror=trigraphs])dnl
  XORG_TESTSET_CFLAG([[BASE_]PREFIX[FLAGS]],[-Werror=array-bounds])dnl
  XORG_TESTSET_CFLAG([[BASE_]PREFIX[FLAGS]],[-Werror=write-strings])dnl
  XORG_TESTSET_CFLAG([[BASE_]PREFIX[FLAGS]],[-Werror=address])dnl
  XORG_TESTSET_CFLAG([[BASE_]PREFIX[FLAGS]],[-Werror=int-to-pointer-cast],
                     [-errwarn=E_BAD_PTR_INT_COMBINATION])dnl
  XORG_TESTSET_CFLAG([[BASE_]PREFIX[FLAGS]],
   [-Werror=pointer-to-int-cast]) # Also -errwarn=E_BAD_PTR_INT_COMBINATION
else
  AC_MSG_WARN([You have chosen not to turn some select compiler warnings into errors. This should not be necessary. Please report why you needed to do so in a bug report at ${PACKAGE_BUGREPORT}])dnl
  XORG_TESTSET_CFLAG([[BASE_]PREFIX[FLAGS]],[-Wimplicit])dnl
  XORG_TESTSET_CFLAG([[BASE_]PREFIX[FLAGS]],[-Wnonnull])dnl
  XORG_TESTSET_CFLAG([[BASE_]PREFIX[FLAGS]],[-Winit-self])dnl
  XORG_TESTSET_CFLAG([[BASE_]PREFIX[FLAGS]],[-Wmain])dnl
  XORG_TESTSET_CFLAG([[BASE_]PREFIX[FLAGS]],[-Wmissing-braces])dnl
  XORG_TESTSET_CFLAG([[BASE_]PREFIX[FLAGS]],[-Wsequence-point])dnl
  XORG_TESTSET_CFLAG([[BASE_]PREFIX[FLAGS]],[-Wreturn-type])dnl
  XORG_TESTSET_CFLAG([[BASE_]PREFIX[FLAGS]],[-Wtrigraphs])dnl
  XORG_TESTSET_CFLAG([[BASE_]PREFIX[FLAGS]],[-Warray-bounds])dnl
  XORG_TESTSET_CFLAG([[BASE_]PREFIX[FLAGS]],[-Wwrite-strings])dnl
  XORG_TESTSET_CFLAG([[BASE_]PREFIX[FLAGS]],[-Waddress])dnl
  XORG_TESTSET_CFLAG([[BASE_]PREFIX[FLAGS]],[-Wint-to-pointer-cast])dnl
...
AC_ARG_ENABLE([strict-compilation],
   ...
   [Enable all compiler warnings & make them errors (default: disabled)])],
...
XORG_TESTSET_CFLAG([[STRICT_]PREFIX[FLAGS]],[-pedantic])dnl
