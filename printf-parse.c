      ...
      if (c == '%') {
          ...
          if (*cp >= '0' && *cp <= '9') {
              ...
              if (*np == '$') {
                  ...
                  for (np = cp; *np >= '0' && *np <= '9'; np++)
                    n = xsum(xtimes(n, 10), (size_t)(*np - '0'));
                  if (n == 0)
          ...
          if (*cp == '*') {
              ...
              REGISTER_ARG(dp->width_arg_index, (size_t)TYPE_INT);
		  } else if (*cp >= '0' && *cp <= '9') {
              size_t width_length;
          ...
          if (*cp == '.') {
              ...
              if (*cp == '*') {
                  ...
                  REGISTER_ARG(dp->precision_arg_index, (size_t)TYPE_INT);
			  } else {
