/* areadlink-with-size.c: readlink wrapper to return the link name in malloc'd
 * storage.
 * Unlike xreadlink and xreadlink_with_size, do NOT ever call exit.
 *
...
areadlink_with_size(char const *file, size_t size)
{
  ...
  size_t INITIAL_LIMIT_BOUND = (8 * 1024); /* (8 * 1024) = 8192 */
